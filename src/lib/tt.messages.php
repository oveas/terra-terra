...
$_messages = array (
		...
		, 'TT_STATUS_BUG'			=> 'A programming bug was found in $p1$ on line $p2$. Message was: "$p3$"'
...
//		, 'TT_STATUS_IVKEY'			=> 'Given security key does not match with this server'
		...
		, 'SOCKET_READERROR'		=> 'Error reading from the socket'
		...
		, 'SOCKET_EOF'				=> 'No more data on the socket'
		, 'SOCKET_USRNOPWD'			=> 'SMTP user $p1$ configured without a password'
		...
		, 'MAIL_IVMAILOPT'			=> 'Invalid mail option $p1$ given'
		...
		, 'SCHEMEHANDLE_EMPTYTABLE'	=> 'The table $p1$ exists but has no fields - this can\'t be possible :-/'
		, 'SCHEMEHANDLE_EXISTS'		=> 'The table $p1$ already exists - no changes made'
		...
		, 'XML_FPARSED'				=> 'The file $p1$ was successfully parsed'
		, 'XML_NOFILOBJ'			=> 'XML parser started without an XML file reference'
		, 'XML_NOSUCHFILE'			=> 'The XML file $p1$ does not exist'
		, 'XML_PARSERR'				=> 'An error occured while parsing $p1$'
		...
		, 'DOM_IVVALUE'				=> 'Value $p1$ is invalid for $p2$'
		...
		, 'THEME_NOSUCHVARIANT'		=> 'Theme $p1$ has no variant $p2$'
		, 'THEME_NOSUCHTHEME'		=> 'Theme $p1$ does not exist'
		, 'THEME_NOSUCHIMAGE'		=> 'Image $p1$ not found in location $p2$ for theme $p3$, variant $p4$'
