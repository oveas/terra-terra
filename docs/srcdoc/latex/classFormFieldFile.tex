...
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}FormFieldFile::\_\-\_\-construct (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classFormFieldFile_a2e19b30454dd3ed054772868bf6eebad}
Class constructor; 
...
\index{FormFieldFile@{FormFieldFile}!restore\_\-status@{restore\_\-status}}
\index{restore\_\-status@{restore\_\-status}!FormFieldFile@{FormFieldFile}}
...
\index{FormFieldFile@{FormFieldFile}!save\_\-status@{save\_\-status}}
\index{save\_\-status@{save\_\-status}!FormFieldFile@{FormFieldFile}}
...
\index{FormFieldFile@{FormFieldFile}!setAttributes@{setAttributes}}
\index{setAttributes@{setAttributes}!FormFieldFile@{FormFieldFile}}
...
\index{FormFieldFile@{FormFieldFile}!setEvent@{setEvent}}
\index{setEvent@{setEvent}!FormFieldFile@{FormFieldFile}}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-value}]Value indicating true (default) or false \end{DoxyParams}
\index{FormFieldFile@{FormFieldFile}!setStyle@{setStyle}}
\index{setStyle@{setStyle}!FormFieldFile@{FormFieldFile}}
...
Boolean indicating a disabled field when true \index{FormFieldFile@{FormFieldFile}!\$events@{\$events}}
\index{\$events@{\$events}!FormFieldFile@{FormFieldFile}}
...
\index{FormFieldFile@{FormFieldFile}!\$id@{\$id}}
...
\index{FormFieldFile@{FormFieldFile}!\$readonly@{\$readonly}}
