...
\item[\mbox{\tt[in]} {\em \$srv}]Database server \item[\mbox{\tt[in]} {\em \$db}]Database name \item[\mbox{\tt[in]} {\em \$usr}]Username to connect with \item[\mbox{\tt[in]} {\em \$pwd}]Password to use for connection \item[\mbox{\tt[in]} {\em \$dbtype}]Database type (reserved for future use, currently only MySQL is implemented) \end{DoxyParams}
...
\item dbtype : Database type (reserved for future use, currently only MySQL is implemented) 
\end{DoxyItemize}\end{DoxyParams}


References open(), and \_\-OWL::set\_\-status().
