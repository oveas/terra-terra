...
\doxyref{Container}{p.}{classContainer}.  
...
\item 
{\bf \_\-\_\-construct} (\$\_\-type, \$\_\-content= '', array \$\_\-attribs=array(), array \$\_\-type\_\-attribs=array())
\item 
{\bf \_\-\_\-call} (\$method, \$arguments=null)
\item 
{\bf setAttributes} (array \$\_\-attribs)
\item 
{\bf setContainer} (array \$\_\-attribs=array())
\item 
{\bf addContainer} (\$type, \$\_\-content= '', array \$\_\-attribs=array(), array \$\_\-type\_\-attribs=array())
\item 
{\bf showElement} ()
\item 
{\bf setId} (\$\_\-value)
...
Class for standard containers. It supports several container type, for each of them the methods 'show$<$Type$>$Type()' must exist. \begin{DoxyAuthor}{Author}
...
\index{Container@{Container}!\_\-\_\-construct@{\_\-\_\-construct}}
\index{\_\-\_\-construct@{\_\-\_\-construct}!Container@{Container}}
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}Container::\_\-\_\-construct (
...
)}\label{classContainer_ac281ecbb24340f3c3a40a6324bdde02a}
Class constructor; 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$\_\-type} & The container type. Supported containertypes are located in plugins/containers \\
\hline
\mbox{\tt in}  & {\em \$\_\-content} & HTML that will be placed in the container \\
\hline
\mbox{\tt in}  & {\em \$\_\-attribs} & Indexed array with the HTML attributes \\
\hline
\mbox{\tt in}  & {\em \$\_\-type\_\-attribs} & Indexed array with the type specific attributes. \\
\hline
\end{DoxyParams}
...
References OWLloader::getClass(), \_\-OWL::init(), setAttributes(), BaseElement::setContent(), and \_\-OWL::setStatus().



\subsection{Member Function Documentation}
\index{Container@{Container}!\_\-\_\-call@{\_\-\_\-call}}
\index{\_\-\_\-call@{\_\-\_\-call}!Container@{Container}}
\subsubsection[{\_\-\_\-call}]{\setlength{\rightskip}{0pt plus 5cm}Container::\_\-\_\-call (
\begin{DoxyParamCaption}
\item[{\$}]{method, }
\item[{\$}]{arguments = {\ttfamily null}}
\end{DoxyParamCaption}
)}\label{classContainer_aa3f4b0353ce8507e9351687653fc60a1}
Magic method to call container specific methods 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$method} & Method name that should be called \\
\hline
\mbox{\tt in}  & {\em \$arguments} & Arguments for the method \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Return value of the method called, or the severity level on an error 
\end{DoxyReturn}
\begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
\index{Container@{Container}!addContainer@{addContainer}}
\index{addContainer@{addContainer}!Container@{Container}}
\subsubsection[{addContainer}]{\setlength{\rightskip}{0pt plus 5cm}Container::addContainer (
\begin{DoxyParamCaption}
\item[{\$}]{type, }
\item[{\$}]{\_\-content = {\ttfamily ''}, }
\item[{array \$}]{\_\-attribs = {\ttfamily array()}, }
\item[{array \$}]{\_\-type\_\-attribs = {\ttfamily array()}}
\end{DoxyParamCaption}
)}\label{classContainer_a1157dd89981699a7aa712e28c65d0ea6}
Add a new subcontainer to this container. 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$type} & Supported container thpe. The method {\itshape add$<$Type$>$()\/} must exist in this container. \\
\hline
\mbox{\tt in}  & {\em \$\_\-content} & Optional HTML content \\
\hline
\mbox{\tt in}  & {\em \$\_\-attribs} & General HTML attributes \\
\hline
\mbox{\tt in}  & {\em \$\_\-type\_\-attribs} & Type specific attributes \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Severity level in case of errors or the return value of the containers {\itshape add$<$Type$>$()\/} method, which is usually a reference to the new container object 
\end{DoxyReturn}
\begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
Referenced by addFormRow().

\index{Container@{Container}!addToContent@{addToContent}}
\index{addToContent@{addToContent}!Container@{Container}}
...
\index{Container@{Container}!check@{check}}
...
\index{Container@{Container}!getAttributes@{getAttributes}}
\index{getAttributes@{getAttributes}!Container@{Container}}
...
Referenced by FormFieldPlugin::getGenericFieldAttributes(), Form::openForm(), Document::showElement(), and showElement().

\index{Container@{Container}!getCallback@{getCallback}}
\index{getCallback@{getCallback}!Container@{Container}}
...
\index{Container@{Container}!getContent@{getContent}}
\index{getContent@{getContent}!Container@{Container}}
...
Referenced by Document::showElement(), showElement(), and Form::showElement().

\index{Container@{Container}!getId@{getId}}
\index{getId@{getId}!Container@{Container}}
...
\index{Container@{Container}!getLastWarning@{getLastWarning}}
\index{getLastWarning@{getLastWarning}!Container@{Container}}
...
\index{Container@{Container}!getSeverity@{getSeverity}}
\index{getSeverity@{getSeverity}!Container@{Container}}
...
\index{Container@{Container}!getStatus@{getStatus}}
\index{getStatus@{getStatus}!Container@{Container}}
...
\index{Container@{Container}!init@{init}}
\index{init@{init}!Container@{Container}}
...
Referenced by FormFieldPlugin::\_\-\_\-construct(), Document::\_\-\_\-construct(), ContainerPlugin::\_\-\_\-construct(), \_\-\_\-construct(), SocketHandler::\_\-\_\-construct(), SessionHandler::\_\-\_\-construct(), SchemeHandler::\_\-\_\-construct(), LogHandler::\_\-\_\-construct(), ImageHandler::\_\-\_\-construct(), FormHandler::\_\-\_\-construct(), FileHandler::\_\-\_\-construct(), DbHandler::\_\-\_\-construct(), HDataHandler::\_\-\_\-construct(), DataHandler::\_\-\_\-construct(), OWL::\_\-\_\-construct(), Mail::\_\-\_\-construct(), Group::\_\-\_\-construct(), Form::\_\-\_\-construct(), Dispatcher::\_\-\_\-construct(), and User::construct().
...
\index{Container@{Container}!restoreStatus@{restoreStatus}}
\index{restoreStatus@{restoreStatus}!Container@{Container}}
...
\index{Container@{Container}!saveStatus@{saveStatus}}
\index{saveStatus@{saveStatus}!Container@{Container}}
...
\index{Container@{Container}!setAttributes@{setAttributes}}
\index{setAttributes@{setAttributes}!Container@{Container}}
\subsubsection[{setAttributes}]{\setlength{\rightskip}{0pt plus 5cm}Container::setAttributes (
\begin{DoxyParamCaption}
\item[{array \$}]{\_\-attribs}
\end{DoxyParamCaption}
)}\label{classContainer_a30a2a62fafb96a382ac910167f38d20f}
Call the containers \doxyref{setAttributes()}{p.}{classContainer_a30a2a62fafb96a382ac910167f38d20f} method 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$\_\-attribs} & Array with HTML attributes \\
\hline
\end{DoxyParams}
\begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
...
Reimplemented from {\bf BaseElement} \doxyref{}{p.}{classBaseElement_a7d8ddd64ceb3401a7cb84548656b3709}.
...
\index{Container@{Container}!setCallbackArgument@{setCallbackArgument}}
\index{setCallbackArgument@{setCallbackArgument}!Container@{Container}}
...
\index{Container@{Container}!setClass@{setClass}}
\index{setClass@{setClass}!Container@{Container}}
...
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
\index{Container@{Container}!setContainer@{setContainer}}
\index{setContainer@{setContainer}!Container@{Container}}
\subsubsection[{setContainer}]{\setlength{\rightskip}{0pt plus 5cm}Container::setContainer (
\begin{DoxyParamCaption}
\item[{array \$}]{\_\-attribs = {\ttfamily array()}}
\end{DoxyParamCaption}
)}\label{classContainer_a17fea842ea2b30a98527daae82e19f7c}
Set container specific attributes 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$\_\-attribs} & Indexed array with the type specific attributes. \\
\hline
\end{DoxyParams}
\begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
\index{Container@{Container}!setContent@{setContent}}
\index{setContent@{setContent}!Container@{Container}}
...
\index{Container@{Container}!setEvent@{setEvent}}
\index{setEvent@{setEvent}!Container@{Container}}
...
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
\index{Container@{Container}!setHighSeverity@{setHighSeverity}}
\index{setHighSeverity@{setHighSeverity}!Container@{Container}}
...
\index{Container@{Container}!setId@{setId}}
\index{setId@{setId}!Container@{Container}}
...
\index{Container@{Container}!setName@{setName}}
\index{setName@{setName}!Container@{Container}}
...
\index{Container@{Container}!setStatus@{setStatus}}
\index{setStatus@{setStatus}!Container@{Container}}
...
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
\index{Container@{Container}!showElement@{showElement}}
\index{showElement@{showElement}!Container@{Container}}
\subsubsection[{showElement}]{\setlength{\rightskip}{0pt plus 5cm}Container::showElement (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classContainer_a966af30a8c244fbc2ee61648fa59ffe3}
Get the HTML code to display the container \begin{DoxyReturn}{Returns}
...
\index{Container@{Container}!signal@{signal}}
\index{signal@{signal}!Container@{Container}}
...
\index{Container@{Container}!stackMessage@{stackMessage}}
\index{stackMessage@{stackMessage}!Container@{Container}}
...
\index{Container@{Container}!succeeded@{succeeded}}
\index{succeeded@{succeeded}!Container@{Container}}
...
\index{Container@{Container}!traceback@{traceback}}
\index{traceback@{traceback}!Container@{Container}}
...
\index{Container@{Container}!\$class@{\$class}}
\index{\$class@{\$class}!Container@{Container}}
...
\index{Container@{Container}!\$containerObject@{\$containerObject}}
\index{\$containerObject@{\$containerObject}!Container@{Container}}
\subsubsection[{\$containerObject}]{\setlength{\rightskip}{0pt plus 5cm}Container::\$containerObject\hspace{0.3cm}{\ttfamily  [private]}}\label{classContainer_a65102889a42244acc956c3ec6a52ffec}
Type specific container object (plugin) \index{Container@{Container}!\$containerType@{\$containerType}}
\index{\$containerType@{\$containerType}!Container@{Container}}
\subsubsection[{\$containerType}]{\setlength{\rightskip}{0pt plus 5cm}Container::\$containerType\hspace{0.3cm}{\ttfamily  [private]}}\label{classContainer_add0a385e75f5a7cfde2fd88c1bef0caa}
\doxyref{Container}{p.}{classContainer} type \index{Container@{Container}!\$events@{\$events}}
\index{\$events@{\$events}!Container@{Container}}
...
\index{Container@{Container}!\$id@{\$id}}
...
Element ID \index{Container@{Container}!\$name@{\$name}}
...
\index{Container@{Container}!\$severity@{\$severity}}
\index{\$severity@{\$severity}!Container@{Container}}
...
\index{Container@{Container}!\$style@{\$style}}
\index{\$style@{\$style}!Container@{Container}}
...
\item 
/home/oscar/projects/owl-\/php/src/kernel/ui/{\bf class.container.php}\end{DoxyCompactItemize}
