...
\mbox{\tt in}  & {\em \$\_\-type} & The container type. Currently supported are:
\begin{DoxyItemize}
\item div
\item label
\item frameset 
...
Class specification \index{Container@{Container}!\$containerObject@{\$containerObject}}
...
Severity level of the current object status \index{Container@{Container}!\$style@{\$style}}
