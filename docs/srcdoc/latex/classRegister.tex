...
References \$\_\-labels, \$GLOBALS, and ConfigHandler::get().
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}\label{classRegister_a80be033f56d821cf6d271ffac2e2d387}
Load the message file for \hyperlink{classOWL}{OWL} and the application 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-force}]Boolean to force a reload with (different) translations, defaults to false \end{DoxyParams}


References \$\_\-messages, \$GLOBALS, and ConfigHandler::get().
