...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classDispatcher_a606996a08d440fdd121443870b942e39}{\$dispatcher}
\end{DoxyCompactItemize}
...
\item[{\$}]{ \_\-dispatcher}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}\label{classDispatcher_a8d39feb182fd4491de589e8b0edc1d25}
Check the format a a dispatcher and decode it 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-dispatcher}]\hyperlink{classDispatcher}{Dispatcher} \end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classDispatcher}{Dispatcher} as an indexed array 
\end{DoxyReturn}
...
Reimplemented from \hyperlink{class__OWL_abded13b1c97ea6e0cfe3c68cb6bcf7a5}{\_\-OWL}.
...
Referenced by FormFieldPlugin::\_\-\_\-construct(), Tablerow::\_\-\_\-construct(), Tablecell::\_\-\_\-construct(), Table::\_\-\_\-construct(), Document::\_\-\_\-construct(), ContainerPlugin::\_\-\_\-construct(), Container::\_\-\_\-construct(), SessionHandler::\_\-\_\-construct(), SchemeHandler::\_\-\_\-construct(), LogHandler::\_\-\_\-construct(), ImageHandler::\_\-\_\-construct(), FormHandler::\_\-\_\-construct(), FileHandler::\_\-\_\-construct(), DbHandler::\_\-\_\-construct(), DataHandler::\_\-\_\-construct(), OWL::\_\-\_\-construct(), Form::\_\-\_\-construct(), \_\-\_\-construct(), and UserHandler::construct().
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-argument}]Argument, must be an array type. When non-\/ arrays should be passed as arguments, the must be set when the callback is registered already \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hyperlink{classRegister}{Register} a callback that wal later be retrieved as dispatcher 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-dispatcher}]Dispatched, \end{DoxyParams}
\begin{DoxySeeAlso}{See also}
\hyperlink{classDispatcher_a8a974bbbb30be7cda74f9929972fd2f6}{Dispatcher::composeDispatcher()} for the format
\end{DoxySeeAlso}
\begin{DoxyReturn}{Returns}
True on success, false on failure 
\end{DoxyReturn}
...
\index{\$dispatcher@{\$dispatcher}!Dispatcher@{Dispatcher}}
\subsubsection[{\$dispatcher}]{\setlength{\rightskip}{0pt plus 5cm}Dispatcher::\$dispatcher\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}\label{classDispatcher_a606996a08d440fdd121443870b942e39}
