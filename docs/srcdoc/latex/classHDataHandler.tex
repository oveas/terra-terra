...
\item 
{\bf getFullOffspring} (\$field, \$value)
\item 
{\bf getDirectChildren} (\$field, \$value)
\item 
...
\item[{\$}]{value}
\end{DoxyParamCaption}
)}\label{classHDataHandler_a1c0fd19bb5ec55ba6dd39f8e35cb18f9}
Retrieve the direct chilren of a given parent 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$field} & Name of the field on which the parent should be matched \\
\hline
\mbox{\tt in}  & {\em \$value} & Value of the parent's field \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Array with all matched records holding the fieldvalue and the depth (always 1, but required for the match) 
\end{DoxyReturn}
\begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
\item[{\$}]{value}
\end{DoxyParamCaption}
)}\label{classHDataHandler_ad3e951acc4e57ea1f074e6d873197325}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$field} & The fieldname of which value that will be returned with the depth \\
\hline
\mbox{\tt in}  & {\em \$value} & An optional value to match if only the depth of 1 field is requested \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Array with all matched records holding the fieldvalue and the depth 
\end{DoxyReturn}
\begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$field} & Name of the field on which the field should be matched \\
\hline
...
Referenced by getDirectChildren(), getFullOffspring(), getLeafNodes(), getNodeDepth(), getPathByChild(), and getPathByParent().
