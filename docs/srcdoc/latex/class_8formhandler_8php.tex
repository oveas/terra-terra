...
\begin{Indent}\paragraph*{Format flags}
{\em These flags define how formdata should be returned }\begin{DoxyCompactItemize}
\item 
...
\doxyref{class.formhandler.php}{p.}{class_8formhandler_8php},v 1.9 2011-\/05-\/02 12:56:14 oscar Exp 
\end{DoxyParagraph}
