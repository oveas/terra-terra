...
Class specification \index{ContainerLegendPlugin@{ContainerLegendPlugin}!\$events@{\$events}}
...
Severity level of the current object status \index{ContainerLegendPlugin@{ContainerLegendPlugin}!\$style@{\$style}}
