...
\index{Document@{Document}!setAttribs@{setAttribs}}
\index{setAttribs@{setAttribs}!Document@{Document}}
\subsubsection[{setAttribs}]{\setlength{\rightskip}{0pt plus 5cm}Document::setAttribs (
\begin{DoxyParamCaption}
\item[{\$}]{ \_\-attribs = {\ttfamily array()}}
\end{DoxyParamCaption}
)}\label{classDocument_aa41033600cf656074f7f5f7c6666d4f2}
Call to the parent's (protected) \hyperlink{classBaseElement_aa623b042d23a5b77add8b3c452ec5855}{setAttributes()} 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-attribs}]Indexed array with the HTML attributes \end{DoxyParams}


References BaseElement::setAttributes().
...
Referenced by Table::\_\-\_\-construct(), Container::\_\-\_\-construct(), Form::\_\-\_\-construct(), and setAttribs().
