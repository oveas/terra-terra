...
\item[\mbox{\tt[in]} {\em \$\_\-dispatcher}]\hyperlink{classDispatcher}{Dispatcher} as an indexed array with the followinf keys:
\begin{DoxyItemize}
...
\end{DoxyItemize}\item[\mbox{\tt[in]} {\em \$\_\-attribs}]Indexed array with the HTML attributes \end{DoxyParams}


References \_\-OWL::init(), owlCrypt(), \_\-OWL::set\_\-status(), and BaseElement::setAttributes().
...
Referenced by Table::\_\-\_\-construct(), Container::\_\-\_\-construct(), \_\-\_\-construct(), and Document::setAttribs().
