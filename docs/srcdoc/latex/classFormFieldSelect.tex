...
\begin{center}
\leavevmode
\includegraphics[height=600pt]{classFormFieldSelect__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[height=600pt]{classFormFieldSelect__coll__graph}
\end{center}
\end{figure}
...
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}FormFieldSelect::\_\-\_\-construct (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classFormFieldSelect_a32c59192be8c316fb2f7e1edde8f0a98}
Class constructor; 
...
\subsubsection[{getFieldCode}]{\setlength{\rightskip}{0pt plus 5cm}FormFieldSelect::getFieldCode (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\label{classFormFieldSelect_ae8875a609d388b03fcc63dd9111b5458}
...
\index{FormFieldSelect@{FormFieldSelect}!restore\_\-status@{restore\_\-status}}
\index{restore\_\-status@{restore\_\-status}!FormFieldSelect@{FormFieldSelect}}
...
\index{FormFieldSelect@{FormFieldSelect}!save\_\-status@{save\_\-status}}
\index{save\_\-status@{save\_\-status}!FormFieldSelect@{FormFieldSelect}}
...
\index{FormFieldSelect@{FormFieldSelect}!setEvent@{setEvent}}
\index{setEvent@{setEvent}!FormFieldSelect@{FormFieldSelect}}
...
\subsubsection[{setMultiple}]{\setlength{\rightskip}{0pt plus 5cm}FormFieldSelect::setMultiple (
\begin{DoxyParamCaption}
\item[{\$}]{ \_\-value = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{classFormFieldSelect_aa69374c1f0692d691e7899f3ed14a42e}
...
\subsubsection[{setSize}]{\setlength{\rightskip}{0pt plus 5cm}FormFieldSelect::setSize (
\begin{DoxyParamCaption}
\item[{\$}]{ size}
\end{DoxyParamCaption}
)}\label{classFormFieldSelect_ad8ae8dcf6f6763cb32966eeca33c472b}
...
\index{FormFieldSelect@{FormFieldSelect}!setStyle@{setStyle}}
\index{setStyle@{setStyle}!FormFieldSelect@{FormFieldSelect}}
...
\subsubsection[{setValue}]{\setlength{\rightskip}{0pt plus 5cm}FormFieldSelect::setValue (
\begin{DoxyParamCaption}
\item[{\$}]{ \_\-value}
\end{DoxyParamCaption}
)}\label{classFormFieldSelect_ae69f5b352df63796c048dca6a2de7544}
Define the options 
\begin{DoxyParams}{Parameters}
...
Boolean indicating a disabled field when true \index{FormFieldSelect@{FormFieldSelect}!\$events@{\$events}}
\index{\$events@{\$events}!FormFieldSelect@{FormFieldSelect}}
...
\index{FormFieldSelect@{FormFieldSelect}!\$id@{\$id}}
...
\index{FormFieldSelect@{FormFieldSelect}!\$options@{\$options}}
