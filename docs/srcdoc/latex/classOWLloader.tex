...
\item[{\$}]{ \_\-driverType}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}\label{classOWLloader_a5911bb36f76142aadfaa6d554113800c}
Load a driverfile 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-driverName}]Name of the class. Will be converted to lowercase to find the classfile \item[\mbox{\tt[in]} {\em \$\_\-driverType}]Driver type, must match the directoryname in OWL\_\-DRIVERS where the classfile can be found \end{DoxyParams}
\begin{DoxyReturn}{Returns}
True on success 
\end{DoxyReturn}


Referenced by DbHandler::load\_\-driver().
