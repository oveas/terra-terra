...
\index{FormFieldText@{FormFieldText}!getEvents@{getEvents}}
\index{getEvents@{getEvents}!FormFieldText@{FormFieldText}}
...
Boolean indicating a disabled field when true \index{FormFieldText@{FormFieldText}!\$id@{\$id}}
