...
Class specification \index{ContainerItemPlugin@{ContainerItemPlugin}!\$events@{\$events}}
...
Severity level of the current object status \index{ContainerItemPlugin@{ContainerItemPlugin}!\$style@{\$style}}
