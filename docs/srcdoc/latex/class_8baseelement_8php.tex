...
This file defines the top-\/level \doxyref{BaseElement}{p.}{classBaseElement} class \begin{DoxyVersion}{Version}

\end{DoxyVersion}
\begin{DoxyParagraph}{Id:}
\doxyref{class.baseelement.php}{p.}{class_8baseelement_8php},v 1.7 2011-\/01-\/21 16:28:15 oscar Exp 
\end{DoxyParagraph}
