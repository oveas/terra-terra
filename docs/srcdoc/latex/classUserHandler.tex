...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classUserHandler_a33b6532ffa6ac263b195bb58c2d770dd}
Confirm a user registration. 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-confirmation}]Array holding the confirmation data (user ID and verification code) \end{DoxyParams}
\begin{DoxyReturn}{Returns}
True on success, false on failure 
\end{DoxyReturn}


Reimplemented in \hyperlink{classUser_acbcc13f994e50ee3f562e9949f6d0638}{User}.
