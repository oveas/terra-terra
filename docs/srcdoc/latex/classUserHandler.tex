...
Inheritance diagram for UserHandler:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{classUserHandler}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
{\bf construct} (\$username)
\item 
{\bf username\_\-exists} (\$username)
\item 
{\bf register} (\$username, \$email, \$password, \$vpassword, \$group)
\item 
{\bf confirm} (array \$\_\-confirmation)
\item 
{\bf logout} (\$reset\_\-status)
\item 
...
This class creates user sessions and handles logging in and out \begin{DoxyAuthor}{Author}
...
Reimplemented in {\bf User} \doxyref{}{p.}{classUser_accd20149a7414612c1505e022eb63ffc}.
...
\index{UserHandler@{UserHandler}!confirm@{confirm}}
\index{confirm@{confirm}!UserHandler@{UserHandler}}
\subsubsection[{confirm}]{\setlength{\rightskip}{0pt plus 5cm}UserHandler::confirm (
\begin{DoxyParamCaption}
\item[{array \$}]{\_\-confirmation}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_a33b6532ffa6ac263b195bb58c2d770dd}
Confirm a user registration. 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$\_\-confirmation} & Array holding the confirmation data (user ID and verification code) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
Reimplemented in {\bf User} \doxyref{}{p.}{classUser_acbcc13f994e50ee3f562e9949f6d0638}.
...
\item[{\$}]{username}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_ae471fe5473119da7089886c27ad5a3e9}
...
Reimplemented in {\bf User} \doxyref{}{p.}{classUser_a9cf024c7e3148e45afd1bee7691ceefd}.



References ConfigHandler::get(), \_\-OWL::init(), read\_\-userdata(), set\_\-username(), and \_\-OWL::succeeded().

\index{UserHandler@{UserHandler}!get\_\-callback@{get\_\-callback}}
\index{get\_\-callback@{get\_\-callback}!UserHandler@{UserHandler}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_a76e8c8b88c8d92f2d03645e810b9253c}
Return the username of the current session 

Reimplemented in {\bf User} \doxyref{}{p.}{classUser_a1348ddf190d4df2518665fb51305a902}.
...
\item[{\$}]{password}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [private]}}\label{classUserHandler_a6b2bbbdb4f1a08578c219a933880a1de}
...
\item[{\$}]{password}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_abf6562660ee8ec1663afe08550a63643}
...
Reimplemented in {\bf User} \doxyref{}{p.}{classUser_a2c4fae5935ebf84e787126795bf42988}.



References ConfigHandler::get(), hash\_\-password(), \_\-OWL::set\_\-status(), and \_\-OWL::traceback().
...
\item[{\$}]{reset\_\-status}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_a0bcf46a5b0c4a5b495cba98b8da02b7b}
Log out the current user. 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$reset\_\-status} & When true, the object status will be reset \\
\hline
\end{DoxyParams}


Reimplemented in {\bf User} \doxyref{}{p.}{classUser_a95e19a7d141f922c2870a6404ff641b1}.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [private]}}\label{classUserHandler_a4e9fb2f7763124ea84ebaf3b744d2d88}
...
\item[{\$}]{group}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_a759bd846745e919ca38a1f7f41b9b355}
...
\hline
\mbox{\tt in}  & {\em \$vpassword} & Given password verification -\/ not used here but must exist in the reimplementation \\
\hline
\mbox{\tt in}  & {\em \$group} & Default group \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
Reimplemented in {\bf User} \doxyref{}{p.}{classUser_a0454a21e40da25584033f99251540ab3}.



References hash\_\-password(), RandomString(), and \_\-OWL::set\_\-callback\_\-argument().
...
\index{UserHandler@{UserHandler}!set\_\-callback@{set\_\-callback}}
\index{set\_\-callback@{set\_\-callback}!UserHandler@{UserHandler}}
...
\index{UserHandler@{UserHandler}!set\_\-callback\_\-argument@{set\_\-callback\_\-argument}}
\index{set\_\-callback\_\-argument@{set\_\-callback\_\-argument}!UserHandler@{UserHandler}}
...
\item[{\$}]{username}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_afbcc9a275b547cca0bd4cff567b054a0}
Set the username 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$username} & Username \\
\hline
...
Referenced by construct(), User::login(), and User::logout().
...
\index{UserHandler@{UserHandler}!succeeded@{succeeded}}
\index{succeeded@{succeeded}!UserHandler@{UserHandler}}
...
\item[{\$}]{username}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_a4b50cc703608c490080b25c5b2ae3418}
...
\subsubsection[{\$dataset}]{\setlength{\rightskip}{0pt plus 5cm}UserHandler::\$dataset\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_ac38c1ea50b2820ed03781bdbe8eb2e08}
...
\subsubsection[{\$session}]{\setlength{\rightskip}{0pt plus 5cm}UserHandler::\$session\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUserHandler_af097b7fd1ee085b46a6c34e071508a7f}
...
\subsubsection[{\$user\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}UserHandler::\$user\_\-data\hspace{0.3cm}{\ttfamily  [private]}}\label{classUserHandler_ae7a2d59eee65560ac96b860e828bb445}
An indexed array with the user information as take from the database 

The documentation for this class was generated from the following file:\begin{DoxyCompactItemize}
\item 
/home/oscar/projects/owl-\/php/src/kernel/so/{\bf class.userhandler.php}\end{DoxyCompactItemize}
