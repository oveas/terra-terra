...
\index{DataHandler@{DataHandler}!DataHandler@{DataHandler}}
\subsubsection[{DataHandler}]{\setlength{\rightskip}{0pt plus 5cm}DataHandler::DataHandler (
\begin{DoxyParamCaption}
\item[{\$}]{ tablename = {\ttfamily ''}}
\end{DoxyParamCaption}
)}\label{classDataHandler_aed5b2eb4ca7b2e4b0c1563d817d73c16}
