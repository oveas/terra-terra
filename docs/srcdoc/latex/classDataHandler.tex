...
\index{DataHandler@{DataHandler}!lock@{lock}}
\index{lock@{lock}!DataHandler@{DataHandler}}
...
\index{DataHandler@{DataHandler}!severity@{severity}}
...
\index{DataHandler@{DataHandler}!\$owl\_\-locks@{\$owl\_\-locks}}
\index{\$owl\_\-locks@{\$owl\_\-locks}!DataHandler@{DataHandler}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}DataHandler::\$owl\_\-locks\hspace{0.3cm}{\tt  \mbox{[}private\mbox{]}}}}
