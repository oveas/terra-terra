...
\item[{\$}]{ \_\-file}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static, private\mbox{]}}}\label{classConfigHandler_a1a9cec0c104e79c5b70eaee3c1f8eaea}
Parse a configuration file 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-file}]Filename \end{DoxyParams}
...
\item[{\$}]{ \_\-force}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static, private\mbox{]}}}\label{classConfigHandler_a07cc4e8a46e645f52c0bfb50baca1184}
Parse a configuration table 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-table}]Config tablename without prefix \item[\mbox{\tt[in]} {\em \$\_\-applic}]Application name for which the config should be read \item[\mbox{\tt[in]} {\em \$\_\-group}]Group ID for which the config should be read \item[\mbox{\tt[in]} {\em \$\_\-user}]\hyperlink{classUser}{User} ID for which the config should be read \item[\mbox{\tt[in]} {\em \$\_\-force}]Boolean that can force overwrite of protected values \end{DoxyParams}
...
Referenced by SessionHandler::\_\-\_\-construct(), LogHandler::\_\-\_\-construct(), OWLException::\_\-\_\-construct(), DbHandler::\_\-\_\-construct(), Session::\_\-\_\-construct(), OWLException::check\_\-hide(), LogHandler::compose\_\-message(), DbHandler::connect(), UserHandler::construct(), User::construct(), FormHandler::get(), DbHandler::get\_\-instance(), UserHandler::hash\_\-password(), UserHandler::isLoggedIn(), LogHandler::log(), OWLExceptionHandler::log\_\-exception(), LogHandler::log\_\-session(), UserHandler::login(), User::logout(), owlCrypt(), User::register(), Register::register\_\-labels(), Register::register\_\-messages(), FormHandler::set(), LogHandler::set\_\-filename(), \_\-OWL::set\_\-status(), \_\-OWL::signal(), OWLException::traceback(), and ContentArea::trn().
...
\item[{\$}]{ \_\-hide}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static, private\mbox{]}}}\label{classConfigHandler_a68fb5e0d30a583d249ae6b407450123d}
Parse a configuration item as read from the file or database, and store is 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-item}]Name of the config item \item[\mbox{\tt[in]} {\em \$\_\-value}]Value of the config item \item[\mbox{\tt[in]} {\em \$\_\-protect}]Boolean indicating a protected value \item[\mbox{\tt[in]} {\em \$\_\-hide}]Boolean indicated a hidden value \end{DoxyParams}
...
\item[{array \$}]{ \_\-source}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}\label{classConfigHandler_aee636634bffead4a620e4e01dd3a9649}
Parse the given configuration source


\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-source}]Array describing the configuration source. It can have the following keys:
\begin{DoxyItemize}
\item \href{file:}{\tt file:} Full path to the configuration file
...
\subsubsection[{\$dataset}]{\setlength{\rightskip}{0pt plus 5cm}ConfigHandler::\$dataset = null\hspace{0.3cm}{\ttfamily  \mbox{[}static, private\mbox{]}}}\label{classConfigHandler_a271a119ca51e0d3da5b8bc2238fc569a}
