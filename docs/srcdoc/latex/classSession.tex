...
\item 
\hyperlink{classSession_a4b7cad06b82b01bef75054a8b859a7c5}{setup} (array \$vars=array())
\item 
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classSession_a39de9a64a03ee2940732ede578bbd928}{ip\_\-address} ()
\end{DoxyCompactItemize}
...
References ConfigHandler::get(), get\_\-session\_\-var(), ip\_\-address(), set\_\-session\_\-var(), \_\-OWL::set\_\-status(), and setup().
...
Status code 
\end{DoxyReturn}
\index{Session@{Session}!get\_\-callback@{get\_\-callback}}
\index{get\_\-callback@{get\_\-callback}!Session@{Session}}
...
\index{Session@{Session}!ip\_\-address@{ip\_\-address}}
\index{ip\_\-address@{ip\_\-address}!Session@{Session}}
\subsubsection[{ip\_\-address}]{\setlength{\rightskip}{0pt plus 5cm}Session::ip\_\-address (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}\label{classSession_a39de9a64a03ee2940732ede578bbd928}
...
Referenced by \_\-\_\-construct(), and setup().
...
\index{Session@{Session}!set\_\-callback@{set\_\-callback}}
\index{set\_\-callback@{set\_\-callback}!Session@{Session}}
...
\index{Session@{Session}!set\_\-callback\_\-argument@{set\_\-callback\_\-argument}}
\index{set\_\-callback\_\-argument@{set\_\-callback\_\-argument}!Session@{Session}}
...
\subsubsection[{setup}]{\setlength{\rightskip}{0pt plus 5cm}Session::setup (
\begin{DoxyParamCaption}
\item[{array \$}]{ vars = {\ttfamily array()}}
\end{DoxyParamCaption}
)}\label{classSession_a4b7cad06b82b01bef75054a8b859a7c5}
Initialize a session 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$vars}]An optional array with key-\/value pairs that will be stored in the session \end{DoxyParams}


References ip\_\-address(), and set\_\-session\_\-var().
...
\subsubsection[{\$dataset}]{\setlength{\rightskip}{0pt plus 5cm}SessionHandler::\$dataset = null\hspace{0.3cm}{\ttfamily  \mbox{[}protected, inherited\mbox{]}}}\label{classSessionHandler_a74c46fcfbadd4c4e6bacc73ddf350056}
