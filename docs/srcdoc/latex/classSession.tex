...
{\bf \_\-\_\-destruct} ()
\item 
{\bf setup} (array \$vars=array())
\item 
{\bf set\_\-rights} (\$bitmap, \$app={\bf OWL\_\-APPL\_\-ID})
\item 
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [private]}}\label{classSession_a39de9a64a03ee2940732ede578bbd928}
...
\index{Session@{Session}!set\_\-rights@{set\_\-rights}}
\index{set\_\-rights@{set\_\-rights}!Session@{Session}}
\subsubsection[{set\_\-rights}]{\setlength{\rightskip}{0pt plus 5cm}Session::set\_\-rights (
\begin{DoxyParamCaption}
\item[{\$}]{bitmap, }
\item[{\$}]{app = {\ttfamily {\bf OWL\_\-APPL\_\-ID}}}
\end{DoxyParamCaption}
)}\label{classSession_a446494dcd7888067b647443854a7f0a8}
...
\end{DoxyParams}
\begin{Desc}
\item[{\bf Todo}]CUrrently, this only works for \doxyref{OWL}{p.}{classOWL} bitmaps; at application level this is not yet implemented \end{Desc}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$vars} & An optional array with key-\/value pairs that will be stored in the session \\
\hline
\end{DoxyParams}
