...
Referenced by getLastWarning(), setStatus(), stackMessage(), and traceback().

\index{\_\-OWL@{\_\-OWL}!stackMessage@{stackMessage}}
\index{stackMessage@{stackMessage}!_OWL@{\_\-OWL}}
\subsubsection[{stackMessage}]{\setlength{\rightskip}{0pt plus 5cm}\_\-OWL::stackMessage (
\begin{DoxyParamCaption}
\item[{\$}]{level = {\ttfamily {\bf OWL\_\-WARNING}}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{class__OWL_acbb85f4949ca4bbd8bb2408362632cbc}
...
References \$\_\-doc, \$severity, OWL::factory(), and signal().
