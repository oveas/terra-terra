...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classUser_acbcc13f994e50ee3f562e9949f6d0638}
Confirm a user registration. 
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-confirmation}]Array that must contain at least the keys 'uid' and 'vcode' \end{DoxyParams}
\begin{DoxyReturn}{Returns}
True on success, false on failure 
\end{DoxyReturn}


Reimplemented from \hyperlink{classUserHandler_a33b6532ffa6ac263b195bb58c2d770dd}{UserHandler}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classUser_a9cf024c7e3148e45afd1bee7691ceefd}
...
Reimplemented from \hyperlink{classUserHandler_ae471fe5473119da7089886c27ad5a3e9}{UserHandler}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}\label{classUser_a4d4ea8d545686fa335e8597f1bab73d2}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-pwd}]The password as a string \item[\mbox{\tt[in]} {\em \$\_\-compare}]An optional array of string to compare with, like username and or email address. If the password if (part of) any of the strings in the array, the strength is decreased. \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\item[{\$}]{ vpassword}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classUser_ac262f6dc9d3a121c25045fe6716e014a}
\hyperlink{classRegister}{Register} a new username


\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$username}]Given username \item[\mbox{\tt[in]} {\em \$email}]Given username \item[\mbox{\tt[in]} {\em \$password}]Given password \item[\mbox{\tt[in]} {\em \$vpassword}]Given password \end{DoxyParams}
\begin{DoxyReturn}{Returns}
New user ID or -\/1 on failure 
\end{DoxyReturn}


Reimplemented from \hyperlink{classUserHandler_a7fbe37f478bf35e0570db3296529e2a4}{UserHandler}.



References ConfigHandler::get(), \_\-OWL::set\_\-status(), and UserHandler::username\_\-exists().
...
Referenced by UserHandler::construct(), login(), and logout().
...
\item[{\$}]{ username}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected, inherited\mbox{]}}}\label{classUserHandler_a4b50cc703608c490080b25c5b2ae3418}
