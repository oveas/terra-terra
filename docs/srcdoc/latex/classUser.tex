...
\item 
{\bf addMembership} (\$groupName, \$aid={\bf OWL\_\-ID}, \$uid=0)
\item 
...
\index{User@{User}!addMembership@{addMembership}}
\index{addMembership@{addMembership}!User@{User}}
\subsubsection[{addMembership}]{\setlength{\rightskip}{0pt plus 5cm}User::addMembership (
\begin{DoxyParamCaption}
\item[{\$}]{groupName, }
\item[{\$}]{aid = {\ttfamily {\bf OWL\_\-ID}}, }
\item[{\$}]{uid = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classUser_a81907d416db995f7c71a1c3c06be57df}
Add a new membership for the given user 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$groupName} & Name of the new group \\
\hline
\mbox{\tt in}  & {\em \$aid} & Application ID the group belongs to, defaults to OWL\_\-ID \\
\hline
\mbox{\tt in}  & {\em \$uid} & Given userID \\
\hline
\end{DoxyParams}
...
References \$dataset, \$group, ConfigHandler::get(), and getUserId().
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \$\_\-confirmation} & Array that must contain at least the keys 'uid' (\doxyref{User}{p.}{classUser} ID) and 'vcode' (Verification Code) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\index{User@{User}!getLastWarning@{getLastWarning}}
\index{getLastWarning@{getLastWarning}!User@{User}}
...
Get the list of all objects this user is member of \begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
Return the current session ID \begin{DoxyReturn}{Returns}
the session ID 
\end{DoxyReturn}
\begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
...
Return the userID of the current session \begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
Referenced by addMembership(), construct(), getMemberships(), and readUserdata().
...
Return the username of the current session \begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
(Re)initialize the user environment \begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
When a new session starts for a use that was logged in before retrieve the userdata back from the database \begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
Restore a user environment \begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
Save the current user environment in the session \begin{DoxyAuthor}{Author}
Oscar van Eijk, Oveas Functionality Provider 
\end{DoxyAuthor}
...
Referenced by addMembership(), and getMemberships().
...
Referenced by addMembership(), and register().
