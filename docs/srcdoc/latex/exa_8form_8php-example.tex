...
This example shows how to create a form and display it. The example code in the comments can be used in the mainpage, e.g. \doxyref{index.php}{p.}{index_8php}.
