...
\end{DoxyCode}
 Where 'right' is the rightsbit to check (e.g. 'readregistered') and the second parameter identifies the application (either OWL\_\-ID or APP\_\-ID) \begin{DoxyReturn}{Returns}
