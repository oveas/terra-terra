...
Pointer to te file when opened \index{FileHandler@{FileHandler}!\$name@{\$name}}
\index{\$name@{\$name}!FileHandler@{FileHandler}}
\subsubsection[{\$name}]{\setlength{\rightskip}{0pt plus 5cm}FileHandler::\$name\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}\label{classFileHandler_a94903bd51b241928ed415ad271c38805}
...
Boolean that's true when the file is opened \index{FileHandler@{FileHandler}!\$original\_\-name@{\$original\_\-name}}
