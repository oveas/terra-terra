...
\subsubsection[{close}]{\setlength{\rightskip}{0pt plus 5cm}FileHandler::close ()\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classFileHandler_aa48e7c3b67346e29b194d2f0ac5dd1f8}
Close the file 
...
\subsubsection[{open}]{\setlength{\rightskip}{0pt plus 5cm}FileHandler::open (\$ {\em mode} = {\ttfamily 'r'})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classFileHandler_a2a650b033c4eb1f98ba47fb05ce7b454}
Open the file
...
\subsubsection[{read\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}FileHandler::read\_\-data ()\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classFileHandler_a1389a6ea19a22471c301d70b5ed68ed8}
...
\subsubsection[{read\_\-line}]{\setlength{\rightskip}{0pt plus 5cm}FileHandler::read\_\-line (\$ {\em trim} = {\ttfamily {\bf FILE\_\-NOTRIM}})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\label{classFileHandler_a69f84a8138f717c84f560125f1f95448}
...
Referenced by UserHandler::\_\-\_\-construct(), SessionHandler::\_\-\_\-construct(), SchemeHandler::\_\-\_\-construct(), ImageHandler::\_\-\_\-construct(), FormHandler::\_\-\_\-construct(), \_\-\_\-construct(), DbHandler::\_\-\_\-construct(), Form::addField(), SchemeHandler::alter\_\-scheme(), close(), DbHandler::connect(), DbHandler::create(), SchemeHandler::create\_\-scheme(), DataHandler::DataHandler(), SchemeHandler::define\_\-index(), SchemeHandler::define\_\-scheme(), Dispatcher::dispatch(), FormHandler::get(), DataHandler::get(), SchemeHandler::get\_\-table\_\-columns(), SchemeHandler::get\_\-table\_\-indexes(), UserHandler::login(), open(), DbHandler::open(), LogHandler::open\_\-logfile(), DataHandler::prepare(), DbHandler::prepare\_\-delete(), DbHandler::prepare\_\-insert(), DbHandler::prepare\_\-read(), DbHandler::prepare\_\-update(), DbHandler::read(), read\_\-line(), UserHandler::read\_\-userdata(), DataHandler::reset(), SchemeHandler::scheme(), FormHandler::set(), DataHandler::set(), DataHandler::set\_\-join(), DataHandler::set\_\-key(), Form::setFieldAttributes(), FormFieldText::setMaxsize(), FormFieldRadio::setSelected(), FormFieldText::setSize(), FormFieldSelect::setSize(), FormFieldSelect::setValue(), FormFieldRadio::setValue(), Form::showField(), SchemeHandler::table\_\-description(), SchemeHandler::validate\_\-scheme(), and DbHandler::write().
