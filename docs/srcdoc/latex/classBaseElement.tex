...
\begin{center}
\leavevmode
\includegraphics[width=150pt]{classBaseElement__coll__graph}
\end{center}
\end{figure}
...
Class specification \index{BaseElement@{BaseElement}!\$events@{\$events}}
