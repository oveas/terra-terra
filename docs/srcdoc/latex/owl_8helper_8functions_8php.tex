...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \$\_\-size}]The string size in characters \item[\mbox{\tt[in]} {\em \$\_\-lowercase}]Boolean that indicates the string should contain lowercase characters only. Default is uppercase only. \end{DoxyParams}
...
Referenced by ConfigHandler::read\_\-config(), FormFieldCheckboxPlugin::setChecked(), FormFieldPlugin::setDisabled(), FormFieldSelectPlugin::setMultiple(), FormFieldPlugin::setReadonly(), and FormFieldSelectPlugin::setValue().
