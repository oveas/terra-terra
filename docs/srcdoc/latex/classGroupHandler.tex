\section{GroupHandler Class Reference}
\label{classGroupHandler}\index{GroupHandler@{GroupHandler}}


the group object  


Inheritance diagram for GroupHandler:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{classGroupHandler}
\end{center}
\end{figure}
...
This is the base class for group objects \begin{DoxyAuthor}{Author}
...
\index{GroupHandler@{GroupHandler}!\_\-\_\-construct@{\_\-\_\-construct}}
\index{\_\-\_\-construct@{\_\-\_\-construct}!GroupHandler@{GroupHandler}}
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}GroupHandler::\_\-\_\-construct (
\begin{DoxyParamCaption}
\item[{\$}]{id}
\end{DoxyParamCaption}
)}\label{classGroupHandler_ac959dc8f3f9000590c1cfa97ed741164}
Class constructor 
...
Reimplemented in {\bf Group} \doxyref{}{p.}{classGroup_a4658f7a59e927da6c639071ef75a5931}.



References \$id, ConfigHandler::get(), get\_\-group\_\-data(), and \_\-OWL::init().



\subsection{Member Function Documentation}
\index{GroupHandler@{GroupHandler}!check@{check}}
\index{check@{check}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!get\_\-callback@{get\_\-callback}}
\index{get\_\-callback@{get\_\-callback}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!get\_\-group\_\-data@{get\_\-group\_\-data}}
\index{get\_\-group\_\-data@{get\_\-group\_\-data}!GroupHandler@{GroupHandler}}
\subsubsection[{get\_\-group\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}GroupHandler::get\_\-group\_\-data (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [private]}}\label{classGroupHandler_af6c5ce77798ed1e8b72d03d0c32dc812}
Read the group information from the database and store it in the internal dataset 

Referenced by \_\-\_\-construct().

\index{GroupHandler@{GroupHandler}!get\_\-group\_\-item@{get\_\-group\_\-item}}
\index{get\_\-group\_\-item@{get\_\-group\_\-item}!GroupHandler@{GroupHandler}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [protected]}}\label{classGroupHandler_a7951d6ccb1ecc408eba1a54ba483e884}
...
Value 
\end{DoxyReturn}
\index{GroupHandler@{GroupHandler}!get\_\-severity@{get\_\-severity}}
\index{get\_\-severity@{get\_\-severity}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!get\_\-status@{get\_\-status}}
\index{get\_\-status@{get\_\-status}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!init@{init}}
\index{init@{init}!GroupHandler@{GroupHandler}}
...
Referenced by FormFieldPlugin::\_\-\_\-construct(), Tablerow::\_\-\_\-construct(), Tablecell::\_\-\_\-construct(), Table::\_\-\_\-construct(), Document::\_\-\_\-construct(), ContainerPlugin::\_\-\_\-construct(), Container::\_\-\_\-construct(), SessionHandler::\_\-\_\-construct(), SchemeHandler::\_\-\_\-construct(), LogHandler::\_\-\_\-construct(), ImageHandler::\_\-\_\-construct(), \_\-\_\-construct(), FormHandler::\_\-\_\-construct(), FileHandler::\_\-\_\-construct(), DbHandler::\_\-\_\-construct(), DataHandler::\_\-\_\-construct(), OWL::\_\-\_\-construct(), Form::\_\-\_\-construct(), Dispatcher::\_\-\_\-construct(), and User::construct().
...
\index{GroupHandler@{GroupHandler}!restore\_\-status@{restore\_\-status}}
\index{restore\_\-status@{restore\_\-status}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!save\_\-status@{save\_\-status}}
\index{save\_\-status@{save\_\-status}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!set\_\-callback@{set\_\-callback}}
\index{set\_\-callback@{set\_\-callback}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!set\_\-callback\_\-argument@{set\_\-callback\_\-argument}}
\index{set\_\-callback\_\-argument@{set\_\-callback\_\-argument}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!set\_\-high\_\-severity@{set\_\-high\_\-severity}}
\index{set\_\-high\_\-severity@{set\_\-high\_\-severity}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!set\_\-status@{set\_\-status}}
\index{set\_\-status@{set\_\-status}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!signal@{signal}}
\index{signal@{signal}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!succeeded@{succeeded}}
\index{succeeded@{succeeded}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!traceback@{traceback}}
\index{traceback@{traceback}!GroupHandler@{GroupHandler}}
...
\index{GroupHandler@{GroupHandler}!\$dataset@{\$dataset}}
\index{\$dataset@{\$dataset}!GroupHandler@{GroupHandler}}
\subsubsection[{\$dataset}]{\setlength{\rightskip}{0pt plus 5cm}GroupHandler::\$dataset\hspace{0.3cm}{\ttfamily  [protected]}}\label{classGroupHandler_ac42cac4ee05f215c218400b85022d6d9}
Link to a datahandler object. This dataset is used as an interface to all database IO. \index{GroupHandler@{GroupHandler}!\$group\_\-data@{\$group\_\-data}}
\index{\$group\_\-data@{\$group\_\-data}!GroupHandler@{GroupHandler}}
\subsubsection[{\$group\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}GroupHandler::\$group\_\-data\hspace{0.3cm}{\ttfamily  [private]}}\label{classGroupHandler_a118c57f74699aad169b1fd664e7d8d10}
An indexed array with the group information as taken from the database \index{GroupHandler@{GroupHandler}!\$id@{\$id}}
\index{\$id@{\$id}!GroupHandler@{GroupHandler}}
\subsubsection[{\$id}]{\setlength{\rightskip}{0pt plus 5cm}GroupHandler::\$id\hspace{0.3cm}{\ttfamily  [private]}}\label{classGroupHandler_aec022db526dda38481146c920ab9c4e2}
\doxyref{Group}{p.}{classGroup} ID 

Referenced by \_\-\_\-construct(), and Group::\_\-\_\-construct().

\index{GroupHandler@{GroupHandler}!\$severity@{\$severity}}
\index{\$severity@{\$severity}!GroupHandler@{GroupHandler}}
...
\item 
/home/oscar/projects/owl-\/php/src/kernel/so/{\bf class.grouphandler.php}\end{DoxyCompactItemize}
