...
\begin{DoxyCompactItemize}
\item 
if(!OWLloader::getClass('form')) {\bf \$LoginForm} = new {\bf Form}('applic\#include-\/path\#classfile\#class\#method')
\item 
{\bf \$\_\-form} = OWL::factory('{\bf FormHandler}')
\item 
{\bf \$\_\-user} = new {\bf User}()
\item 
{\bf switch} (\$\_\-form-\/$>$get('act'))
\item 
{\bf \$\_\-scheme} = SchemeHandler::get\_\-instance()
\item 
{\bf \$\_\-table}
\item 
{\bf \$\_\-index}
\item 
{\bf \$\_\-t} = serialize(\$\_\-data['columns'])
\end{DoxyCompactItemize}
...
\doxyref{index.php}{p.}{index_8php},v 1.12 2011-\/04-\/06 14:42:16 oscar Exp 
\end{DoxyParagraph}
...
\subsubsection[{\$\_\-t}]{\setlength{\rightskip}{0pt plus 5cm}\$\_\-t = serialize(\$\_\-data['columns'])}\label{index_8php_a7a22c26026cc0626b015085e752b45cb}


Referenced by DbHandler::extract\_\-tablelist(), and DataHandler::prepare().
